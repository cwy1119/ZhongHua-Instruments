...
class watermark():
    ...
    def init_block_add_index(self,img_shape):
        ...
        if not shape0_int*shape1_int>=self.wm_shape[0]*self.wm_shape[1]:
            print("水印的大小超过图片的容量")
            # print(shape0_int,shape1_int,self.wm_shape[0],self.wm_shape[1])
    ...
    def read_ori_img(self,filename):
        ...
        # self.ori_img_shape_o = ori_img.shape[:2]
        # ori_img = cv2.resize(ori_img, (400, 400))
        # self.ori_img_shape = [400, 400]
        # print(self.ori_img_shape)
    ...
    def embed(self,filename):
        ...
        # embed_img = cv2.resize(embed_img, self.ori_img_shape_o)
...
if __name__=="__main__":
    ...
    # bwm1 = watermark(4399,2333,32)
    # bwm1.read_ori_img("03.jpg")
    # bwm1.read_wm("./application/static/img/qcode.png")
    # bwm1.embed('out.jpg')
    # bwm1.extract('out.jpg','bwm1_out.jpg')
    pass
